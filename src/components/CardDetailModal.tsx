...
import type { Card, Column, CardMember } from '../types/board';
...
export default function CardDetailModal({
  ...
  const handleAttach = (file: { name: string; url: string }) => {
    ...
    onUpdate({ ...card, attachmentFiles: files, attachments: files.length });
  };
  ...
  const handleDeleteChecklist = (clId: string) => {
    onUpdate({ ...card, checklists: (card.checklists || []).filter((cl) => cl.id !== clId) });
  };
  ...
  const renderPanel = () => {
    ...
    switch (openPanel) {
      ...
      case 'labels':
        return <LabelsPanel card={card} onUpdate={onUpdate} onClose={closePanel} onBack={() => setOpenPanel('add')} />;
      case 'dates':
        return <DatesPanel card={card} onUpdate={onUpdate} onClose={closePanel} onBack={() => setOpenPanel('add')} />;
      case 'checklist':
        return <ChecklistPanel card={card} onUpdate={onUpdate} onClose={closePanel} onBack={() => setOpenPanel('add')} />;
      case 'members':
        return <MembersPanel card={card} onUpdate={onUpdate} onClose={closePanel} onBack={() => setOpenPanel('add')} />;
      case 'attachment':
          ...
          <div className="modal-sidebar">
            <div className="modal-section">
              ...
              <div className="activity-item">
                <div className="activity-avatar">KK</div>
                <div className="activity-text">
                  <strong>kuzo kuzo</strong> added this card to {columnTitle}
                  <br />
